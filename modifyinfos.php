...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <?php 
        if($admin=="oui") {
          echo "<a class='nav-link' href='allemp.php'><b>Employés</b></a>";
          echo "</li>";
...
<div>
    ...
    <tbody>";
        $query = "SELECT * FROM employe WHERE id_emp=$idm";
        ...
        echo 
          ...
          <form action='http://localhost/pfa/modify2.php?idm=$idm' method='post'>
          <tr class='center-buttons transparent-background no-border'>
            <td><input class='form-control' type='number' name='nidm'></td>
  ...
  <div class="center-content-horizontal">
    <?php
    $query = "SELECT taux_horaire,cotisations_sociales,salaire_brut,jours_conge,jours_conge_restants FROM etat WHERE id_emp=$idm";
    $result = $con->query($query);
    echo "
    <table style='width: 600px;'>
    <thead>
    <tr>
        <th colspan='6' style='text-align:center'><b>Informations suplémentaires</b></th>
    </tr>
    <tr>
        <th>Taux horaire</th>
        <th>Salaire Brut</th>
    ...
    while($etat=$result->fetch_assoc()) {
      ...
      <td>" . $etat['cotisations_sociales']*100 . "</td>
      ...
      <tr class='center-buttons transparent-background no-border'>
        ...
        <td></td>
        <td><input class='form-control' type='number' name='tax'></td>
        <td><input class='form-control' type='number' name='conge'></td>
        <td><input class='form-control' type='number' name='congeres'></td>
      </tr>
      </tbody>
      </table>
      <div align='center'>
