...
<div class="mb-3"></div>
<div class="container">
  <div class="square-box"><a href="salaire.php">Salaire</a></div>
  <div class="square-box"><a href="conge.php">Demande de congé</a></div>
  <div class="square-box"><a href="hispoint.php">Historique de pointage</a></div>
  <?php 
    if($admin=="oui")
    {
      echo "<div class='square-box'><a href='allemp.php'>Employés</a></div>";
      echo "<div class='square-box'><a href='Addemp.php'>Ajout d'employés</a></div>";
    }
  ?>
</div>
