...
$admin=$row["admin"];
$query = "SELECT date_debut,date_fin FROM pointage WHERE emp_id=$id order by date_debut desc";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="hispoint.php"><b>Historique de pointage</b></a>
      </li>
      <li class="nav-item">
      <?php 
        if($admin=="oui") {
...
<?php
    ...
    <tbody>";
        ...
        {
          while($pointage = mysqli_fetch_assoc($result))
          {
            echo 
            "<tr>
            <td>" . $pointage['date_debut'] . "</td>
            <td>" . $pointage['date_fin'] . "</td>
            </tr>
            ";
          }
          echo "
